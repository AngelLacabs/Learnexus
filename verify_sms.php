                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <div class="alert alert-success text-center">
                            ...
                            <p class="mb-0">The verification code has been sent to your phone.</p>
                            <p class="mb-0"><strong><?php echo htmlspecialchars($maskedPhone); ?></strong></p>
                            <p>Please check your messages to verify your account.</p>
                        </div>
        ...
        <div class="col-md-6 d-none d-md-block bg-light">
            <div class="h-100 d-flex align-items-center justify-content-center p-5">
                <div class="text-center">
                    ...
                    <p class="text-muted">Protecting your account with phone verification</p>
                </div>
            </div>
        </div>
    </div>
