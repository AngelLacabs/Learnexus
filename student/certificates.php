                            ...
                            <div class="position-relative" style="flex: 1; max-width: 500px;">
                                <form method="GET" class="position-relative w-100">
                                    ...
                                    <input type="text" name="search" id="certificateSearch"
                                        class="form-control search-input ps-5" placeholder="Search certificates..."
                    ...
                    <div class="col-12">
                        <div class="alert alert-info d-flex justify-content-between align-items-center">
                            ...
                            <button class="btn btn-sm btn-outline-secondary rounded-pill"
                                onclick="window.location.href='certificates.php'">
                            ...
                            <div class="card border-0 rounded-4 shadow-sm card-hover h-100"
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="d-flex flex-column gap-2 small text-muted mb-3">
                                        ...
                                        <div><i
                                                class="bi bi-calendar-check me-2"></i><?php echo date('F d, Y', strtotime($cert['issuedAt'])); ?>
                                        </div>
                                        <div><i
                                                class="bi bi-hash me-2"></i><?php echo substr($cert['certificateUUID'], 0, 8); ?>
                                        </div>
                                    </div>
                        ...
                        <div class="card border-0 rounded-4 shadow-sm">
                            <div class="card-body text-center py-5">
                                ...
                                <?php if (!empty($searchQuery)): ?>
                                    ...
                                    <p class="text-muted mb-4">No certificates match
