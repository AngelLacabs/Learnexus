        ...
        <main class="main-content p-3 p-lg-4">
            <div class="container-fluid" style="max-width: 1200px;">
                        ...
                        <div class="card stat-card">
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <h6 class="text-muted mb-1">Quizzes</h6>
                        ...
                        <ul class="nav nav-tabs-custom d-flex flex-wrap" id="courseTabs" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link <?php echo $activeTab === 'students' ? 'active' : ''; ?>" 
                                        id="students-tab" data-bs-toggle="tab" data-bs-target="#students" type="button" role="tab">
                ...
                <div class="tab-content" id="courseTabsContent">
                        ...
                        <div class="section-card">
                            ...
                            <?php if (count($quizzes) > 0): ?>
                                <?php foreach ($quizzes as $quiz): ?>
                                    <div class="lesson-item">
                                        <div class="d-flex align-items-center">
                                            <i class="bi bi-patch-question text-primary fs-4 me-3"></i>
                                            <div>
                                        ...
                                        <div class="d-flex gap-2">
                                            <a href="edit_quiz.php?id=<?php echo $quiz['quizID']; ?>" class="btn btn-outline-primary btn-sm">
                                                <i class="bi bi-pencil me-1"></i> Edit
                                            </a>
                                            <a href="quizresults.php?id=<?php echo $quiz['quizID']; ?>" class="btn btn-outline-info btn-sm">
                            ...
                            <?php else: ?>
                                <div class="empty-state">
                                    ...
                                    <p class="text-muted mb-4">Create your first quiz to test your students' knowledge!</p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <!-- Students Tab -->
                    <div class="tab-pane fade <?php echo $activeTab === 'students' ? 'show active' : ''; ?>" id="students" role="tabpanel">
                        <div class="section-card">
                            <div class="section-title">
                                ...
                                <?php foreach ($allStudents as $student): ?>
                                    <div class="student-row">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="text-muted small"><?php echo round($student['progressPercentage']); ?>% Complete</div>
                                        </div>
                                        <div>
